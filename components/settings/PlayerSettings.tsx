...
export function PlayerSettings({
    ...
    return (
        <div className="bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-[var(--radius-2xl)] shadow-[var(--shadow-sm)] p-6 mb-6">
            <h2 className="text-xl font-semibold text-[var(--text-color)] mb-4">播放器設定</h2>
            ...
            <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <button
                            ...
                            className={`px-4 py-3 rounded-[var(--radius-2xl)] border text-left font-medium transition-all duration-200 cursor-pointer ${fullscreenType === 'native'
                                ? 'bg-[var(--accent-color)] border-[var(--accent-color)] text-[var(--bg-color)] shadow-[0_4px_12px_rgba(var(--accent-color-rgb),0.3)]'
                        ...
                        >
                            ...
                            <div className="text-sm opacity-80 mt-1">播放器填滿目前瀏覽器視窗</div>
                        </button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        >
                            <div className="font-semibold">智慧重試 (推薦)</div>
                        ...
                        >
                            ...
                            <div className="text-sm opacity-80 mt-1">所有請求都透過代理轉發</div>
                        </button>
                    </div>
                </div>
            </div>
