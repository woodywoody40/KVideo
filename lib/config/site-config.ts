...
export const siteConfig: SiteConfig = {
  title: process.env.NEXT_PUBLIC_SITE_TITLE || "WoodyTV - 影片聚合平台",
  description: process.env.NEXT_PUBLIC_SITE_DESCRIPTION || "影片聚合平台",
  name: process.env.NEXT_PUBLIC_SITE_NAME || "WoodyTV",
};